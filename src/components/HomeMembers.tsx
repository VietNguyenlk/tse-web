    ...
    <div className="space-y-8">
      ...
      <div className="relative bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 text-white">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold mb-4">Chào mừng đến với CLB Lập trình</h1>
          <p className="text-lg opacity-90 mb-6">
            Nơi kết nối đam mê công nghệ và phát triển kỹ năng lập trình chuyên nghiệp
          </p>
        ...
        <div className="lg:col-span-2 bg-white rounded-xl shadow-sm p-6">
          <div className="mb-6">
            <div className="flex items-center space-x-2 mb-2">
              ...
              <h2 className="text-xl font-semibold text-gray-900">Sự kiện sắp diễn ra</h2>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="mb-6">
            <div className="flex items-center space-x-2 mb-2">
              ...
              <h2 className="text-xl font-semibold text-gray-900">Lộ trình học tập</h2>
            </div>
            ...
            {[
              ...
              <div key={index} className="p-4 rounded-lg hover:bg-gray-50 transition-colors">
                <div className="flex justify-between items-start">
                  ...
                  <span className="text-sm text-gray-400">{course.students} học viên</span>
                </div>
              </div>
            ))}
          </div>
